...
[![Travis Automated build](https://travis-ci.org/yawpitch/docker-ansible-ubuntu.svg?branch=zesty)](https://travis-ci.org/yawpitch/docker-ansible-ubuntu/branches)
...
```sh
sudo docker pull yawpitch/docker-ansible-ubuntu-zesty:latest
```
...
```sh
sudo docker build -t docker-ansible-ubuntu-zesty .
```
