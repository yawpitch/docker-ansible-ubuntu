# Ubuntu Yakkety (16.10 LTS) Ansible Test Image

[![Travis Automated build](https://travis-ci.org/yawpitch/docker-ansible-ubuntu-yakkety.svg?branch=master)](https://travis-ci.org/yawpitch/docker-ansible-ubuntu-yakkety/)
[![Docker Automated build](https://img.shields.io/docker/automated/yawpitch/docker-ansible-ubuntu-yakkety.svg?maxAge=2592000)](https://hub.docker.com/r/yawpitch/docker-ansible-ubuntu-yakkety/)

Dockerized Ubuntu Yakkety (16.10 LTS) for Ansible playbook and role tests.
...
```sh
sudo docker pull yawpitch/docker-ansible-ubuntu-yakkety:latest
```
...
```sh
sudo docker build -t docker-ansible-ubuntu-yakkety .
```
